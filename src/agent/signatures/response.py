...
class GenerateResponseSignature(dspy.Signature):
    """
    ...
    IMPORTANT: When interpretation_note is provided, ALWAYS end with a follow-up question
    asking if the user was looking for something else (e.g., a different interpretation).
    """
    ...
    user_language: Literal["pt", "en"] = dspy.InputField(desc="Target language for the response")
